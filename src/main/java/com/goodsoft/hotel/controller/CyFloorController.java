...
public class CyFloorController {
    ...
    @ResponseBody
    public Object transformTable(String orderId, String currentTable, String transTable, String aoh) {
        if (orderId != null && currentTable != null && transTable != null) {
            ...
            try {
                ...
                this.repastOrderDao.updateOrderCTDao(transTable, orderId, aoh);
                sqlSession.commit();
                return new Status(StatusEnum.SUCCESS.getCODE(), StatusEnum.SUCCESS.getEXPLAIN());
            } catch (Exception e) {
                sqlSession.rollback();
